								...
								if($result->num_rows > 0)
								{
									while($row = $result->fetch_assoc()) {
										echo "<div class=\"box-header\" data-original-title>
											<h2><i class=\"halflings-icon white edit\"></i><span class=\"break\"></span>Read Taman</h2>
											</div>
											...
											<div class=\"control-group\">
											  ...
											  <div class=\"controls\">
												<span class=\"input-xlarge uneditable-input\" type=\"text\" id=\"date01\" name=\"username\">".$row["Nama_Instansi"]."</span>
											  </div>
											</div>
