...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Repark | Masuk Sebagai Admin</title>
                    ...
                    <form class="form-horizontal" action="logincheck.php" method="post">
                        <fieldset>
                            ...
                            <div class="input-prepend" title="Username">
                                ...
                                <input class="input-large span10" name="user-name" id="username" type="text" placeholder="type username" />
                            </div>
                            <div class="clearfix"></div>

                            <div class="input-prepend" title="Password">
                                <span class="add-on"><i class="halflings-icon lock"></i></span>
                                <input class="input-large span10" name="pass-word" id="password" type="password" placeholder="type password" />
                            </div>
                            <div class="clearfix"></div>
